    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-muted p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-serif">{isSignup ? "Join AstroWeb" : "Welcome to AstroWeb"}</CardTitle>
          <CardDescription>
            {isSignup
              ? "Create your account to start your cosmic journey"
              : "Sign in to access your astrology consultations"}
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-muted-foreground">
              ...
              <Button variant="link" className="p-0 ml-1 h-auto" onClick={() => setIsSignup(!isSignup)}>
